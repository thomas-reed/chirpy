...
func main() {
	...
	if polkaKey == "" {
		log.Fatalln("polka api key not found")
	}
	...
	mux.HandleFunc("PUT /api/users", apiConfig.updateUserCredsHandler)
	...
	mux.HandleFunc("POST /api/polka/webhooks", apiConfig.addChirpyRedHandler)
